                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-header"> SLIP GAJI ONLINE <span class="float-right">
                                <strong><?php echo date('F', strtotime($row->waktu_payroll)); ?></strong>&nbsp; <?php echo date('Y', strtotime($row->waktu_payroll)); ?></span> </div>
                        <div class="card-body">
                            <div class="row mb-5">
                                ...
                                <div class="mt-4 col-xl-6 col-lg-6 col-md-12 col-sm-12 d-flex justify-content-lg-end justify-content-md-center justify-content-xs-start">
                                    <div class="row align-items-center">
                                        <div class="col-sm-9">
                                            ...
                                            <span>Your payment amount: <strong class="d-block">Rp. <?php echo number_format($row->gaji_pokok + $row->tunjangan, 2, ",", ".") ?> <small>(<?= $row->channel_bayar ?>)</small></strong>
                                                <br>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="left strong">Rp. <?php echo number_format($row->gaji_pokok, 0, ",", ".") ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="left strong">Uang Makan</td>
                                                    <td class="left strong">Rp. <?php echo number_format($row->tunjangan, 0, ",", ".") ?></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="left strong">Rp. <?php echo number_format($alfa, 0, ",", ".") ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="left strong">PPH 5%</td> 
                                                    <td class="left strong">Rp. <?php echo number_format($pph, 0, ",", ".") ?></td>
                                                </tr>
                                                <tr>
                                                    <td class="left strong">TOTAL</td>
                                                    <td class="left strong"><b>Rp. <?php echo number_format($alfa + $pph, 0, ",", ".") ?></b></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
